...
--
-- Host: 127.0.0.1:3308
-- Generation Time: Aug 18, 2026 at 04:08 PM
...
(2, 'Chartering', 'Self-geared and semi-geared vessels', 'Feeder ships, barges, landing craft and deep-sea mother vessels, matched to weight, volume and route.', 'assets/img/services/heavy-lift-chartering.jpg', 'Crane lifting a large fabricated module at a Singapore port', 'Get a Quote', 'contact.php', 2, 'active', '2026-08-17 08:20:22'),
(3, 'Our fleet', 'Our own trailers, our own lashing crew', 'Fleet, in-house lashing and an open yard for storage and re-working, under one operation.', 'assets/img/services/project-freight-forwarding.jpg', 'Oversized vessel section secured on a Carriage Global low-bed trailer', 'Get a Quote', 'contact.php', 3, 'active', '2026-08-17 08:20:22');
...
INSERT INTO `services` (`id`, `title`, `slug`, `link`, `short_desc`, `intro`, `image`, `icon`, `alt_text`, `meta_title`, `meta_desc`, `sort_order`, `status`, `created_at`, `updated_at`) VALUES
(1, 'Project Freight Forwarding', 'project-freight-forwarding', 'project-freight-forwarding.php', 'Mode chosen from your packing list, not from a price list. The practical route, costed against the urgency that actually applies.', NULL, 'assets/img/services/project-freight-forwarding.jpg', 'assets/img/icons/s-icons1.svg', 'Oversized vessel section secured on a CGS low-bed trailer', NULL, NULL, 1, 'active', '2026-08-17 07:10:11', '2026-08-17 07:31:50'),
(2, 'Chartering Heavy Lift & Semi-Geared Vessels', 'heavy-lift-chartering', 'heavy-lift-chartering.php', 'Break bulk and project cargo on self-geared and semi-geared vessels, matched to cargo weight, volume and route.', NULL, 'assets/img/services/heavy-lift-chartering.jpg', 'assets/img/icons/s-icons2.svg', 'Crane lifting a large fabricated module at a Singapore port', NULL, NULL, 2, 'active', '2026-08-17 07:10:11', '2026-08-17 07:31:50'),
(3, 'Chartering Tug & Barge', 'tug-and-barge-chartering', 'tug-and-barge-chartering.php', 'Shallow-draft and remote-site delivery where deep-water port infrastructure does not reach.', NULL, 'assets/img/services/tug-and-barge-chartering.jpg', 'assets/img/icons/s-icons3.svg', 'Barge and tug working alongside a geared vessel', NULL, NULL, 3, 'active', '2026-08-17 07:10:11', '2026-08-17 07:31:50'),
(4, 'Roll On / Roll Off', 'roll-on-roll-off', 'roll-on-roll-off.php', 'Mafi trailers and ramp operations for rolling stock and awkward breakbulk units.', NULL, 'assets/img/services/roll-on-roll-off.jpg', 'assets/img/icons/s-icons4.svg', 'Drilling equipment on an oversized trailer at the quayside', NULL, NULL, 4, 'active', '2026-08-17 07:10:11', '2026-08-17 07:31:50'),
(5, 'Air Freight', 'air-freight', 'air-freight.php', 'Time-critical and AOG shipments, including oversize and dangerous goods handling.', NULL, 'assets/img/services/air-freight.jpg', 'assets/img/icons/s-icons5.svg', 'Palletised and shrink-wrapped air cargo in a warehouse', NULL, NULL, 5, 'active', '2026-08-17 07:10:11', '2026-08-17 07:31:50');
...
(1, 'assets/img/logo/cgs-logo.jpg', NULL, 'assets/img/logo/cgs-favicon.jpg', 'assets/img/bg/hero-bg.jpg', 'Cargo that does not fit a container, moved anyway', 'Heavy lift, break bulk and project cargo by sea, air and road, planned from your packing list.', 'assets/video/cgs-video-band.mp4', NULL, 'Carriage Global (S) Pte Ltd', 'CGS', '200714170K', 'An ISO 9001:2015 Certified Company', 18, 'Carriage Global provides integrated customized logistics for the oil and gas, offshore, heavy lift, energy, construction and mining sectors, managing and optimizing supply chains from origin to final site.', '+65 6899 8251', '+65 6515 6106', '+65 6472 5443', NULL, 'angeline@carriageglobal.com', '21 Bukit Batok Crescent, WCEGA Tower #17-82, Singapore 658065', NULL, 'Carriage Global (M) Sdn Bhd', '1236698-V', 'Suite 28.02, 28th Floor, Menara Zurich No.15, Jalan Dato Abdullah Tahir, Johor Bahru, Johor', NULL, NULL, NULL, 'https://www.facebook.com/carriageglobal', 'https://www.instagram.com/carriageglobal', 'https://www.linkedin.com/company/carriage-global', NULL, NULL, NULL, '2026-08-18 12:52:20');
